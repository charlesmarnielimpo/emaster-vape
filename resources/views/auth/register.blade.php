        ...
        <div class="panel-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
            ...
            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
              <label for="txt-register-first-name" class="col-md-4 control-label">First Name</label>

              <div class="col-md-6">
                  <input id="txt-register-first-name" type="text" class="form-control" name="first_name" value="{{ old('first_name') }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
              <label for="txt-register-last-name" class="col-md-4 control-label">Last Name</label>

              <div class="col-md-6">
                  <input id="txt-register-last-name" type="text" class="form-control" name="last_name" value="{{ old('last_name') }}" required autofocus>
